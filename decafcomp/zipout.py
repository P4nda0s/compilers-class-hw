...
class ZipOutput:
    ...
    def __init__(self, opts):
        ...
        self.answer_dir = "/Users/pandaos/Projects/compilers-class-hw/decafexpr/answer" # name of directory where run_program exists
...
if __name__ == '__main__':
    ...
    optparser.add_option("-r", "--run", dest="run_program", default='decafexpr', help="run this program against testcases [default: decafcomp]")
